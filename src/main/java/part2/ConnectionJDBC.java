...
public class ConnectionJDBC {
    ...
    public static void main(String[] args) {
        ...
        String url = "jdbc:mysql://localhost:3306/digital_innovation_one?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
        String user = "root";
        String pass = "seichonoie";
